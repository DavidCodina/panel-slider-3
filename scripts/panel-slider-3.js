...
function indicate_slide(index){
  /* Is this needed? Technically no, but what we should really do is
  pass 'this' to indicate slide, then grab closest(".slider-container").
  Then grab the SPECIFIC slice_containers and slices. */
  ...
  //
  //        slices[i].classList.remove("slide-out-up");
  //        slices[i].classList.remove("slide-out-down");
  //
  //
  ...
  for (let i = 0; i < slices.length; i++) {
    slices[i].classList.add("slide-out-up");
    slices[i].classList.add("slide-out-down");
  }
  ...
  for (let i = 0; i < slice_containers.length; i++){
    ...
    slice.classList.remove("slide-out-up");
    slice.classList.remove("slide-out-down");
